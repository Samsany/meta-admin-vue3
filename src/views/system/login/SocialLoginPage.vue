<template>
  <div class="app-loading">
    <div class="app-loading-wrap">
      ...
      <div class="app-loading-title">AUIU-META微服务平台</div>
    </div>
  </div>
</template>

<script lang="ts" setup name="SocialLogin">
/**
 * 第三方授权登录，跳转至此页面进行登录操作
 */
...
const state = routeQuery['state']
if (!code && !state) {
  createMessage.warning('参数无效')
}
const userStore = useUserStore()
userStore
  .login({ grant_type: 'social', ...routeQuery })
  .then(res => {
