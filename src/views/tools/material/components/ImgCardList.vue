    ...
    <div class="p-4 bg-white">
      <div class="flex justify-between space-x-2">
        <div class="flex justify-start space-x-2">
          ...
          <a-button type="primary" preIcon="ant-design:upload-outlined" @click="handleUploadClick"> 上传文件</a-button>
          <!--          <BasicUpload-->
          <!--            :maxSize="20"-->
          <!--            :maxNumber="10"-->
...
import { delAttachment, getAttachmentList } from '/@/api/tools/material'
